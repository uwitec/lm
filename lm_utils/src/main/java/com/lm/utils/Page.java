...
public class Page<T> {
	...
	public String getLinks() {
		...
		sBuf.append("<a href=\"javaScript:void(0);").append("\" onclick=\"setPageNo(1);formSubmit('").append(url).append("','_self')");
		sBuf.append("\">[首页]");
		sBuf.append("</a>&nbsp;");
		...
		sBuf.append("<a href=\"javaScript:void(0);").append("\" onclick=\"setPageNo(").append(curPageNo).append(");formSubmit('")
		...
		sBuf.append("<a href=\"javaScript:void(0);").append("\" onclick=\"setPageNo(").append(this.totalPage).append(");formSubmit('")
				.append(url).append("','_self')");
		sBuf.append("\">[末页]");
		sBuf.append("</a>&nbsp;");
